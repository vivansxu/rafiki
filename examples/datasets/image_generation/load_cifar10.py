...
def load(train_dataset_url, out_train_dataset_path):
    ...
    for batch in range(1, 6):
        with open(os.path.join(train_dataset_file_path, 'data_batch_%d' % batch), 'rb') as file:
...
if __name__ == '__main__':
    load(
        train_dataset_url='https://www.cs.toronto.edu/~kriz/cifar-10-python.tar.gz',
        out_train_dataset_path='data/cifar10_for_image_generation'
    )
